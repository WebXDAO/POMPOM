            ...
            <div className="flex justify-between h-16">
              <div className="flex">
                ...
                <div className="hidden md:ml-6 md:flex md:space-x-8">
                  ...
                  <a
                    href="#"
                    className="text-lg text-gray-700 inline-flex items-center px-1 pt-1 text-sm font-medium"
                  >
                    Home
                  </a>
                  <a
                    href="#"
                    className="text-lg text-gray-700 hover:text-gray-700 inline-flex items-center px-1 pt-1 text-sm font-medium"
                  >
                    How it works ?
                  </a>
                  <a
